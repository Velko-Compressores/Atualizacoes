...
// Página C3-4CES_4CC — Prefixo + catálogo local (sem preço)
window.PAGE_PREFIX = 'C3-4CES-4CC';
window.PRODUCT_CATALOG = {
  1:  { id: 1,  name: 'JOGO DE VEDACOES - 4CC/4CES', img: 'assets/images/pecas-C3-4FES-4FC/1 - JOGO DE VEDACOES.png',  desc: 'Peça de vedação para compressores.' },
