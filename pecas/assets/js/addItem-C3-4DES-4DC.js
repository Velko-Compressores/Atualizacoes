...
window.PAGE_PREFIX = 'C3-4DES-4DC';
window.PRODUCT_CATALOG = {
  1:  { id: 1,  name: 'JOGO DE VEDACOES - 4DC/4DES', img: 'assets/images/pecas-C3-4FES-4FC/1 - JOGO DE VEDACOES.png',  desc: 'Peça de vedação para compressores.' },
