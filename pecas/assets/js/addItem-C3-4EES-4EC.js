...
// Página C3-4EES_4EC — Prefixo + catálogo local (sem preço)
window.PAGE_PREFIX = 'C3-4EES-4EC';
window.PRODUCT_CATALOG = {
  1:  { id: 1,  name: 'JOGO DE VEDACOES - 4EC/4EES', img: 'assets/images/pecas-C3-4FES-4FC/1 - JOGO DE VEDACOES.png',  desc: 'Peça de vedação para compressores.' },
