...
window.PRODUCT_CATALOG = {
  1:  { id: 1,  name: 'Item1-Gasket set - C3-4FES-4FC',  img: 'images/1 - Gasket set.png',  desc: 'Conjunto de juntas para compressores C3-4CES-4CC.' },
  5:  { id: 5,  name: 'Item5-Gasket set - C3-4FES-4FC',  img: 'images/1 - Gasket set.png',  desc: 'Conjunto de juntas para manutenção preventiva.' },
  9:  { id: 9,  name: 'Item9-Gasket set - C3-4FES-4FC',  img: 'images/1 - Gasket set.png',  desc: 'Peça de reposição original.' },
  11: { id: 11, name: 'Item11-Gasket set - C3-4FES-4FC', img: 'images/1 - Gasket set.png',  desc: 'Compatível com linha C4-4VES-6.' },
  13: { id: 13, name: 'Item13-Gasket set - C3-4FES-4FC', img: 'images/1 - Gasket set.png',  desc: 'Alta durabilidade e vedação.' },
  24: { id: 24, name: 'Item24-Gasket set - C3-4FES-4FC', img: 'images/1 - Gasket set.png',  desc: 'Recomendado para revisões programadas.' },
  30: { id: 30, name: 'Item30-Gasket set - C3-4FES-4FC', img: 'images/1 - Gasket set.png',  desc: 'Item compatível com diversos modelos.' },
  33: { id: 33, name: 'Item33-Gasket set - C3-4FES-4FC', img: 'images/1 - Gasket set.png',  desc: 'Aplicação em compressores C4-4PES-10.' },
  34: { id: 34, name: 'Item34-Gasket set - C3-4FES-4FC', img: 'images/1 - Gasket set.png',  desc: 'Ótima vedação e performance.' },
  55: { id: 55, name: 'Item55-Gasket set - C3-4FES-4FC', img: 'images/1 - Gasket set.png',  desc: 'Peça original de reposição.' },
  57: { id: 57, name: 'Item57-Gasket set - C3-4FES-4FC', img: 'images/1 - Gasket set.png',  desc: 'Instalação simples e rápida.' },
  75: { id: 75, name: 'Item75-Gasket set - C3-4FES-4FC', img: 'images/1 - Gasket set.png',  desc: 'Confiabilidade comprovada.' }
};
