...
window.PRODUCT_CATALOG = {
  1:  { id: 1,  name: 'JOGO DE VEDACOES - 4FC/4FES', img: '../../assets/images/pecas-C3-4FES-4FC//1 - JOGO DE VEDACOES.png',  desc: 'Peça de vedação para compressores.' },
  5:  { id: 5,  name: 'ARRUELA FX CV ROTOR - 45 X 12,5 X 3,5 C2/C3/CE2/CE3', img: '../../assets/images/pecas-C3-4FES-4FC/5 - ARRUELA FX CV ROTOR.png',  desc: 'Chave paralela para fixação segura.' },
  9:  { id: 9,  name: 'ARRUELA LISA - A10 X 16 X 2 DIN7603 C2/3/4 CE2/3/4', img: '../../assets/images/pecas-C3-4FES-4FC/9 - ARRUELA LISA.png',  desc: 'Arruela para suporte mecânico.' },
  11: { id: 11, name: 'BUCHA MANCAL - 40 X 36 X 30 2EL..2CL/C2/C3/CE2/CE3', img: '../../assets/images/pecas-C3-4FES-4FC/11 - BUCHA MANCAL.png', desc: 'Compatível com linha C4-4VES-6.' },
  13: { id: 13, name: 'CJ DISCO DINÂMICO DE ÓLEO - C3/CE3', img: '../../assets/images/pecas-C3-4FES-4FC/13 - CJ DISCO DINÂMICO DE ÓLEO.png', desc: 'Alta durabilidade e vedação.' },
  24: { id: 24, name: 'ANEL DE ENCOSTO DU - 46 X 37,5 X 3 C2/C3 CE2/CE3', img: '../../assets/images/pecas-C3-4FES-4FC/24 - ANEL DE ENCOSTO DU.png', desc: 'Recomendado para revisões programadas.' },
  30: { id: 30, name: 'CJ CABEÇOTE AR - CE2/CE3', img: '../../assets/images/pecas-C3-4FES-4FC/30 - CJ CABEÇOTE AR.png', desc: 'Item compatível com diversos modelos.' },
  33: { id: 33, name: 'PLACA DE VÁLVULAS COM VEDACOES - 041 4FC/4FES', img: '../../assets/images/pecas-C3-4FES-4FC/33 - PLACA DE VÁLVULAS COM VEDACOES.png', desc: 'Aplicação em compressores C4-4PES-10.' },
  34: { id: 34, name: 'VEDAÇÕES PLACA DE VÁLVULA - 041 4FC/4FES', img: '../../assets/images/pecas-C3-4FES-4FC/34 - VEDAÇÕES PLACA DE VÁLVULA.png', desc: 'Ótima vedação e performance.' },
  55: { id: 55, name: 'CJ TAMPA MOTOR - PEQ C2/C3 CE2/CE3', img: '../../assets/images/pecas-C3-4FES-4FC/55 - CJ TAMPA MOTOR.png', desc: 'Peça original de reposição.' },
  57: { id: 57, name: 'CJ RESISTÊNCIA DE CÁRTER - 0..120W-PTC/200..260V C2/3 CE2/3', img: '../../assets/images/pecas-C3-4FES-4FC/57 - CJ RESISTÊNCIA DE CÁRTER.png', desc: 'Instalação simples e rápida.' },
  75: { id: 75, name: 'CJ TAMPA MANCAL - C3/CE3', img: '../../assets/images/pecas-C3-4FES-4FC/75 - CJ TAMPA MANCAL.png', desc: 'Confiabilidade comprovada.' }
...
document.getElementById("continueShoppingButton").addEventListener("click", function() {
  ...
  const url = "../../assets/images/pecas-C3-4FES-4FC//1 - JOGO DE VEDACOES.png";
  console.log('Testando URL direta:', url);

  // cria um link clicável para abrir a imagem
  const a = document.createElement('a');
  a.href = url;
  a.textContent = 'Abrir imagem em nova aba';
  a.target = '_blank';
  document.body.appendChild(a);

  // testa via Image para ver se carrega
  const img = new Image();
  img.onload  = () => console.log('Imagem carregou: OK (200)');
  img.onerror = () => console.error('Falhou: 404/erro de caminho');
  img.src = url;
